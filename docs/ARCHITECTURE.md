...
| Миграции      | goose                     | поддержка Go-функций, timestamp-нумерация — меньше конфликтов             |
| БД драйвер    | pgx/pgxpool               | нативный PostgreSQL драйвер, быстрее database/sql, встроенный пул         |
